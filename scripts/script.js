...
const popupFieldNameEdit = popupEdit.querySelector(
  ".popup__field_name-input-edit"
);
const popupFieldDescriptionEdit = popupEdit.querySelector(
  ".popup__field_description-input-edit"
);
const popupSaveButtonEdit = popupEdit.querySelector(".popup__save_edit");

const popupAdd = document.querySelector(".popup_add");
const popupFieldNameAdd = popupAdd.querySelector(
  ".popup__field_name-input-add"
);
const popupFieldDescriptionAdd = popupAdd.querySelector(
  ".popup__field_description-input-add"
);
...
const popupPhotoDescription = document.querySelector(
  ".popup-photo__description"
);
